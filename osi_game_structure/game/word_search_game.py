...
def draw_taskbar():
    ...
    screen.blit(font.render("CHECK EFFECT", True, (255,255,255)),
                (back_btn.x+25, back_btn.y+10))
...
def draw_popup():
    ...
    # YES
    screen.blit(font.render("YES! I DONT", True, (255,255,255)),
                (yes_btn.x + 10, yes_btn.y + 5))
    screen.blit(font.render("CARE", True, (255,255,255)),
                (yes_btn.x + 40, yes_btn.y + 25))

    # NO
    screen.blit(font.render("NO! I WONT", True, (255,255,255)),
                (no_btn.x + 5, no_btn.y + 5))
    screen.blit(font.render("HURT THEM", True, (255,255,255)),
                (no_btn.x + 15, no_btn.y + 25))
...
while running:
    ...
    #pygame.draw.rect(screen, (0,0,255), hitbox3, 2)
